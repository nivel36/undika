...
/**
 * The class {@code DuplicatePersonException} indicates that a {@code Person}
 * being created or modified is the same as a person that has been created
 * before.
 *
 * @author Abel Ferrer
 */
public final class DuplicatePersonException extends Exception {
	 ...
	 */
	public DuplicatePersonException(Throwable cause) {
		super(cause);
	}
	 ...
	 */
	public DuplicatePersonException(String message, Throwable cause, boolean enableSuppression,
